...
## [v0.3.0](https://github.com/puppetlabs/influxdb/tree/v0.3.0) (2022-04-04)

[Full Changelog](https://github.com/puppetlabs/influxdb/compare/v0.3.0...v0.3.0)

### UNCATEGORIZED PRS; LABEL THEM ON GITHUB

- Add spec tests for all providers [\#22](https://github.com/puppetlabs/influxdb/pull/22) ([m0dular](https://github.com/m0dular))
